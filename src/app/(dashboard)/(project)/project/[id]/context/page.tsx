...
const ProjectContext = () => {
  ...
  useEffect(() => {
    toast((t) => (
      <span>
        ...
        post for you.
        <button className="bg-gray-300 py-2 px-4 rounded-lg mt-2" onClick={() => toast.dismiss(t.id)}>Dismiss</button>
      </span>
    ),{
      duration: 4000,
    });
  ...
  const submit = async () => {
    ...
    toast
      .promise(updateContext(JSON.stringify(finalResponse)), {
        loading: "Submitting...",
  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <button
        onClick={submit}
        className=" btn btn-primary text-white py-2 px-6 rounded-lg"
      >
        Submit
      </button>
    </div>
