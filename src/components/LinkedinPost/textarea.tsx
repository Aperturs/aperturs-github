...
const LinkedInPostCreation: React.FC<LinkedInPostCreationProps> = ({ content, onContentChange }) => {
  return (
    <div className="relative">
      <textarea
        className="w-full min-h-[300px] max-h-[700px] border border-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal outline-none focus:outline-none clip-content"
